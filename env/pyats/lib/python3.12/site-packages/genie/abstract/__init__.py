...
from .package import AbstractTree, AbstractPackage, merge_packages  # noqa F401
...
# ``merge_packages`` is part of the public abstraction API so callers can
# explicitly compose many abstract packages into one lookup namespace.
__all__ = ['Lookup', 'LookupDecorator', 'merge_packages']
...
def declare_package(*args, **kwargs):
    ...
    # get the module object from caller's frame
